...
void CImageListView::OnDraw(CDC* pDC)
{
	...
	m_il.Draw(pDC, 0, CPoint(50, 150), ILD_NORMAL);
	m_il.Draw(pDC, 0, CPoint(150, 150), ILD_TRANSPARENT);
	m_il.Draw(pDC, 0, CPoint(250, 150), ILD_BLEND25);
	m_il.Draw(pDC, 0, CPoint(350, 150), ILD_BLEND50);
	m_il.Draw(pDC, 0, CPoint(450, 150), ILD_MASK);
}
