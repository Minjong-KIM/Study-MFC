...
// TreeViewDoc.cpp: CTreeViewDoc 클래스의 구현
//
...
CTreeViewDoc::CTreeViewDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CTreeViewDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CTreeViewDoc::InitializeSearchContent()
{
...
void CTreeViewDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
