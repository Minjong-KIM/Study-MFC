...
// TreeView.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CTreeViewApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTreeViewApp::OnAppAbout)
...
CTreeViewApp::CTreeViewApp() noexcept
{
	...
	SetAppID(_T("TreeView.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CTreeViewApp 개체입니다.
